...
**Почему сейчас (несмотря на старую заметку “не внедрять FTS” в историческом backlog):**
...
- SearchField сверху + Tabs:
  ...
  - **Notes**,
  - **Quotes** (highlights).
- Навигация: `GlobalSearchScreen` доступен как вкладка “Поиск” (BottomNav/NavigationRail).
