...
### Checklist
- [ ] Тест “копирование в app storage”.
- [ ] Тест “dedup по fingerprint (sha-256)”.
- [ ] Тест “ошибка при отсутствии файла / отсутствии прав”.
- [ ] Тест “верификация расширения .epub (если логика есть)” (опционально).
