...
**Входит**
- Global Search v2 (отдельный экран, открывается из Library).
...
**Ожидаемо**
- Открывается экран “Поиск” (Global Search).
...
- Позиция примерно соответствует найденному месту (в пределах главы/абзаца).
 - Кнопка back возвращает на экран поиска с сохранёнными результатами.
